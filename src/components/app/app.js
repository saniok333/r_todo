...
export default class App extends Component {
   ...
   search(tData, trm, sts) {
      if (sts.length) {
         return tData.filter((el) => ((el.label.toLowerCase().includes(trm.toLowerCase())) && (el.done == +sts)))
      } else {
   ...
   render() {
      ...
      const visibleItems = this.search(todoData, term, status);
